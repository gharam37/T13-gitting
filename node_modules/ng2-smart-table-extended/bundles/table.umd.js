/**
  * @license ng2-smart-table v1.0.19
...
var Cell = (function () {
    function Cell(value, row, column, dataSet, isNew) {
        this.value = value;
        this.row = row;
        this.column = column;
    ...
    Cell.prototype.isEditable = function () {
        if (this.getRow().index === -1) {
            ...
            var valid = this.column.getIsEditableFunction() instanceof Function;
            var isEditableFunc = valid ? this.column.getIsEditableFunction() : Cell.EDITABLE;
...
Cell.EDITABLE = function (cell) { return cell.getColumn().isEditable; };

var Row = (function () {
    function Row(index, data, _dataSet, isNew) {
        this.index = index;
        this.data = data;
...
var Column = (function () {
    ...
    Column.prototype.getInputFormatFunction = function () {
        return this.inputFormatFunction;
    };
    Column.prototype.getIsEditableFunction = function () {
...
var DataSet = (function () {
    ...
    DataSet.prototype.createRows = function () {
        ...
        this.data.forEach(function (el, index) {
            _this.rows.push(new Row(index, el, _this, false));
        });
    };
    return DataSet;
}());
...
var CellComponent = (function () {
    function CellComponent() {
        ...
        this.mode = 'inline';
        this.isInEditing = false;
        this.completed = new _angular_core.EventEmitter();
        this.edited = new _angular_core.EventEmitter();
        this.changed = new _angular_core.EventEmitter();
...
var EditCellDefault = (function () {
    ...
    EditCellDefault.prototype.onChange = function (event) {
        event.stopPropagation();
...
var CompleterEditorComponent = (function (_super) {
    ...
    function CompleterEditorComponent(completerService) {
        ...
        _this.completerStr = '';
        _this.completed = new _angular_core.EventEmitter();
        return _this;
    }
    ...
    CompleterEditorComponent.prototype.onEditedCompleter = function (data) {
        this.cell.newValue = data.title;
        this.completed.emit({ data: data, row: this.cell.getRow() });
        return false;
    };
...
var InputEditorComponent = (function (_super) {
    ...
    InputEditorComponent.prototype.ngAfterContentInit = function () {
    ...
    InputEditorComponent.prototype.onKeyup = function (event) {
        if (this.formatFunction) {
...
Ng2SmartTableTbodyComponent = __decorate$25([
    _angular_core.Component({
        ...
        template: "<tr *ngFor=\"let row of grid.getRows()\" (click)=\"userSelectRow.emit(row)\" (mouseover)=\"rowHover.emit(row)\" class=\"ng2-smart-row\" [className]=\"rowClassFunction(row)\" [ngClass]=\"{selected: row.isSelected}\"><td *ngIf=\"isMultiSelectVisible\" class=\"ng2-smart-actions ng2-smart-action-multiple-select\" (click)=\"multipleSelectRow.emit(row)\"><input type=\"checkbox\" class=\"form-control\" [ngModel]=\"row.isSelected\"></td><td *ngIf=\"!row.isInEditing && showActionColumnLeft\" class=\"ng2-smart-actions\"><ng2-st-tbody-custom *ngIf=\"showCustomDuringView\" [grid]=\"grid\" (custom)=\"custom.emit($event)\" [row]=\"row\" [source]=\"source\"></ng2-st-tbody-custom><ng2-st-tbody-edit-delete [grid]=\"grid\" [deleteConfirm]=\"deleteConfirm\" [editConfirm]=\"editConfirm\" (edit)=\"edit.emit(row)\" (delete)=\"delete.emit(row)\" (editRowSelect)=\"editRowSelect.emit($event)\" [row]=\"row\" [source]=\"source\"></ng2-st-tbody-edit-delete></td><td *ngIf=\"row.isInEditing && showActionColumnLeft\" class=\"ng2-smart-actions\"><ng2-st-tbody-create-cancel *ngIf=\"showUpdateCancel\" [grid]=\"grid\" [row]=\"row\" [editConfirm]=\"editConfirm\" (save)=\"save.emit($event)\"></ng2-st-tbody-create-cancel><ng2-st-tbody-custom *ngIf=\"showCustomDuringEdit\" [grid]=\"grid\" [row]=\"row\" [source]=\"source\" (custom)=\"custom.emit($event)\"></ng2-st-tbody-custom></td><td *ngFor=\"let cell of row.cells\" [className]=\"cellClassFunction(cell)\"><ng2-smart-table-cell [cell]=\"cell\" [grid]=\"grid\" [row]=\"row\" [isNew]=\"false\" [mode]=\"mode\" [editConfirm]=\"editConfirm\" [inputClass]=\"editInputClass\" [isInEditing]=\"row.isInEditing\" (completed)=\"completed.emit($event)\" (changed)=\"changed.emit($event)\" (save)=\"save.emit($event)\"></ng2-smart-table-cell></td><td *ngIf=\"row.isInEditing && showActionColumnRight\" class=\"ng2-smart-actions\"><ng2-st-tbody-create-cancel [grid]=\"grid\" [row]=\"row\" [editConfirm]=\"editConfirm\"></ng2-st-tbody-create-cancel></td><td *ngIf=\"!row.isInEditing && showActionColumnRight\" class=\"ng2-smart-actions\"><ng2-st-tbody-custom [grid]=\"grid\" (custom)=\"custom.emit($event)\" [row]=\"row\" [source]=\"source\"></ng2-st-tbody-custom><ng2-st-tbody-edit-delete [grid]=\"grid\" [deleteConfirm]=\"deleteConfirm\" [editConfirm]=\"editConfirm\" [row]=\"row\" [source]=\"source\" (edit)=\"edit.emit(row)\" (delete)=\"delete.emit(row)\" (editRowSelect)=\"editRowSelect.emit($event)\"></ng2-st-tbody-edit-delete></td></tr><tr *ngIf=\"grid.getRows().length == 0\"><td [attr.colspan]=\"grid.getColumns().length + (isActionAdd || isActionEdit || isActionDelete)\">{{ noDataMessage }}</td></tr>",
    })
...
var TheadFormRowComponent = (function () {
    ...
    TheadFormRowComponent.prototype.ngAfterContentInit = function () {
...
var TheadCustomComponent = (function () {
    function TheadCustomComponent() {
        this.custom = new _angular_core.EventEmitter();
        this.selectedItem = {};
    }
    TheadCustomComponent.prototype.ngAfterContentInit = function () {
        var _this = this;
        // console.log( 'setting up select action default values');
        var customActions = this.grid.getSetting('actions.custom');
        if (customActions && customActions.length > 0) {
    ...
    TheadCustomComponent.prototype.onSelect = function (action) {
        event.preventDefault();
        event.stopPropagation();
        this.custom.emit({
            action: action,
    ...
    TheadCustomComponent.prototype.onCustom = function (action, event) {
        event.preventDefault();
        event.stopPropagation();
        this.custom.emit({
            action: action,
...
TheadCustomComponent = __decorate$40([
    _angular_core.Component({
...
var Ng2SmartTableComponent = (function () {
    function Ng2SmartTableComponent() {
        ...
        this.defaultSettings = {
            ...
            cellClassFunction: function () { return ""; },
        };
